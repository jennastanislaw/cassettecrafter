...
To run an example from the `cassettecrafter` directory (parent directory of `src`):`python3 src/main.py -u ./test_data/demo_mutation_list.csv -f ./test_data/test_seq_single.csv -M 50 -m 30`
